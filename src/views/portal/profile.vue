<template>
    <div dir="rtl" class="main-container bg-[linear-gradient(117deg,_#e7f0f9_-5.98%,_#efefef_107.97%)] h-screen flex justify-center items-center">
        <div
            class="inner-container shadow-[0px_2px_8px_0px_rgba(10,102,194,0.07)] w-[100%] h-[100%] flex flex-col bg-[#FAFAFA] min-[700px]:flex-col min-[700px]:h-[72%] min-[700px]:w-[80%] min-[700px]:rounded-[45px] min-[1024px]:w-[75%] min-[1280px]:w-[70%] min-[1280px]:h-[75%]"
        >
            <div class="w-full flex max-[699px]:flex-col h-[100%]">
                <div
                    class="right-box z-50 shadow-[0px_2px_8px_0px_rgba(10,102,194,0.07)] flex flex-col justify-center items-center bg-white max-[700px]:h-[27%] min-[700px]:w-[30%] min-[700px]:h-full min-[700px]:rounded-r-[45px] min-[1024px]:w-[25%]"
                >
                    <div class="flex flex-col gap-5 max-[700px]:gap-1 items-center w-[50%]">
                        <div class="flex relative justify-center items-center">
                            <div class="w-28 h-28 max-[1150px]:w-24 max-[1150px]:h-24 max-[699px]:w-16 max-[699px]:h-16">
                                <img
                                    class="profile-picture w-[100%] h-[100%] border border-gray-100 rounded-full"
                                    :src="profileForm.profileImage || defaultProfile"
                                    :alt="profileForm.profileImagePreview ? '' : ''"
                                ...
                                <img
                                    ...
                                    v-if="profileForm.profileImagePreview"
                                />
                            </div>
                        ...
                        <div class="flex flex-col min-[700px]:gap-5 max-[700px]:gap-1 items-center justify-center">
                            <div class="flex flex-col min-[700px]:gap-4 max-[700px]:gap-3 items-center text-center">
                                <button type="button"
                                    v-tippy:click
                                    class="text-[22px] text-[#0985AA] font-semibold text-wrap leading-9 max-[700px]:text-[16px] max-[1150px]:text-[18px] max-[1150px]:leading-6"
                                >   {{ truncatedName }}
    
                                </button>
                                <tippy target="click" trigger="click">{{ fullName }}</tippy>
                            </div>
                            <div class="flex gap-2 text-[#2375C8] font-semibold max-[850px]:flex-col max-[699px]:flex-row">
                                <button
                                    @click="submit_profile_form"
                                    type="submit"
                                    class="border border-[#2375C8] rounded px-5 py-1.5 flex gap-1 items-center max-[699px]:text-[12px] max-[699px]:px-4"
                                >
                                    ذخیره
                                </button>
                                <button
                                    @click="cancel"
                                    type="button"
                                    class="border border-[#2375C8] rounded px-4 py-1.5 flex gap-1 items-center max-[699px]:text-[12px] max-[699px]:px-3"
                                >
                                    انصراف
                                </button>
                            </div>
                ...
                <div class="left-box w-[77%] max-[700px]:w-full max-[700px]:h-[73%] min-[700px]:w-[70%] min-[700px]:h-[100%] min-[1024px]:w-[75%]">
                    <div class="h-full relative md:rounded-tl-[45px] flex items-center justify-between shadow-[0px_2px_8px_0px_rgba(10,102,194,0.07)] w-full">
                        <div class="flex items-center justify-center w-full h-full">
                            <div class="h-[100%] w-full flex justify-center items-center">
                                <TabGroup class="w-full h-full" as="div">
                                    <TabList
                                        class="flex px-8 h-[10%] max-[1536px]:h-[12%] items-center justify-between shadow-[0px_2px_8px_0px_rgba(10,102,194,0.07)] md:rounded-tl-[45px]"
                                    >
                                    ...
                                    <TabPanels class="h-[90%] max-[1536px]:h-[88%]">
                                        <TabPanel class="w-full h-full max-[700px]:py-5">
                                            <div class="h-[100%] min-[700px]:h-full max-[700px]:h-full flex justify-center items-center">
                                                <div
                                                    class="form-box w-[70%] !h-[70%] max-[700px]:!h-full max-[699px]:overflow-y-auto flex justify-center max-lg:w-[85%] max-lg:h-full max-[700px]:w-[85%] min-[1024px]:w-[80%] min-[1024px]:h-[60%]"
                                                >
                                                    <form
                                                        ...
                                                        @submit.prevent="submit_profile_form()"
                                                    >
                                                        <div :class="{ 'has-error': $profileFormValidation.profileForm.firstName.$error }">
                                                            ...
                                                            <div class="relative flex items-center">
                                                                <input
                                                                    id="customFname"
                                                                    type="text"
                                                                    class="form-input p-3 pe-10 rounded-lg text-[15px] text-[#7e7e7e] max-[1150px]:text-[14px] max-[1150px]:p-2"
                                                            ...
                                                            <template v-if="isSubmitProfileForm && $profileFormValidation.profileForm.firstName.$error">
                                                                <p class="text-danger mt-1 text-xs">لطفا نام خود را وارد نمایید.</p>
                                                            </template>
                                                        </div>
                                                        <div :class="{ 'has-error': $profileFormValidation.profileForm.lastName.$error }">
                                                            ...
                                                            <template v-if="isSubmitProfileForm && $profileFormValidation.profileForm.lastName.$error">
                                            ...
                                            <div class="h-[100%] min-[700px]:h-full max-[700px]:h-full flex justify-center items-center">
                                                ...
                                                >
                                                    <form
                                                        ...
                                                        @submit.prevent="submit_profile_form()"
                                                    >
                                                        <div :class="{ 'has-error': $resetPasswordFormValidation.resetPasswordForm.oldPassword.$error }">
                                                            <label
                                                                class="text-[16px] font-normal text-[#616161] max-[1150px]:text-[14px]"
                                                                for="customOldPassword"
                                                                >رمز عبور قدیمی:</label
                                                            >
                                                            <div class="relative flex items-center">
                                                                <input
                                                                    id="customOldPassword"
                                                                    :type="showPassword.oldPassword ? 'password' : 'text'"
                                                                    class="form-input p-3 pe-10 text-[15px] rounded-lg text-[#7e7e7e] max-[1150px]:text-[14px] max-[1150px]:p-2"
                                                                    v-model.trim="resetPasswordForm.oldPassword"
                                                                    autocomplete="new-password"
                                                                />
                                                                <div class="absolute end-5 cursor-pointer">
                                                                    <svg
                                                                        @click="toggle_password_visibility('oldPassword')"
                                                                        v-if="showPassword.oldPassword"
                                                                        class="max-[1150px]:w-[16px] max-[1150px]:h-[16px]"
                                                                        width="24"
                                                                        height="24"
                                                                        viewBox="0 0 24 24"
...
<script setup lang="ts">
    ...
    const isSubmitProfileForm = ref(false);
    ...
    let profileForm = ref<IprofileForm>({
        firstName: '',
        lastName: '',
        phoneNumber: '',
        profileImage: '',
    ...
    const $profileFormValidation = useVuelidate(profileFormRules, { profileForm });
    const $resetPasswordFormValidation = useVuelidate(resetPasswordFormRules, { resetPasswordForm });

    const submit_profile_form = async () => {
        isSubmitProfileForm.value = true;
        $profileFormValidation.value.profileForm.$touch();
        $resetPasswordFormValidation.value.resetPasswordForm.$touch();

        if ($profileFormValidation.value.profileForm.$invalid || $resetPasswordFormValidation.value.resetPasswordForm.$invalid) {
            isSubmitProfileForm.value = true;
            return;
        }
        try {
            ...
            isSubmitProfileForm.value = false;
        }
    };
    ...
    let _tempData = <IprofileForm>{};
    const cancel = () => {
        profileForm.value = { ..._tempData };
        isSubmitProfileForm.value = false;
        router.back();
    };
    ...
    const upload_image = (e) => {
        ...
        profileForm.value.profileImagePreview = URL.createObjectURL(file);
    };
    ...
    const fetch_user_data = () => {
        taxios()
            ?.get('/users/' + authStore.loginInfo.userId)
            .then((res) => {
                const user = res.data.content.user;
                let { firstName, lastName, phoneNumber, profileImage, email } = user;
                profileForm.value = { firstName, lastName, phoneNumber, profileImage, email };
                _tempData = { ...profileForm.value };
            })
            .catch((error) => {
    ...
    const edit_user_data = async () => {
        return new Promise((resolve, reject) => {
            ...
            for (let [key, value] of Object.entries(profileForm.value)) {
            ...
            taxios(import.meta.env.VITE_MAIN_URL, 'multipart/form-data')
                ?.put('/users/profile/' + authStore.loginInfo.userId, formData)
                .then((res) => {
    ...
    const reset_password = () => {
        return new Promise((resolve, reject) => {
            taxios()
                ?.post('/resetPassword', resetPasswordForm.value)
                .then((res) => {
